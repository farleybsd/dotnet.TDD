...
namespace NerdStore.Vendas.Domain.Tests
{
    ...
    {
        [Fact(DisplayName = "Validar Voucher Tipo Valor Vàlido")]
        [Trait("Categoria", "Vendas - Voucher")]
        public void Voucher_ValidarVoucherTipoValor_DeveSerValido()
        {
            //Arrange
        ...
        [Fact(DisplayName = "Validar Voucher Tipo Valor Invàlido")]
        [Trait("Categoria", "Vendas - Voucher")]
